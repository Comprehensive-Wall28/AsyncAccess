...
import {  Container, Typography, Grid, Card, CardContent, Button, CircularProgress, Alert, CardActions } from '@mui/material';
      ...
      <Grid container spacing={4} justifyContent="center">
        {events.map((event) => (
          <Grid item key={event._id || event.id} xs={12} sm={6} md={4}> 
            <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column', transition: 'transform 0.2s ease-in-out, box-shadow 0.2s ease-in-out', '&:hover': { transform: 'scale(1.03)', boxShadow: (theme) => theme.shadows[6], cursor: 'pointer' } }} onClick={() => handleEventClick(event._id || event.id)}>
              ...
              <CardContent sx={{ flexGrow: 1 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ 
                  ...
                  minHeight: '3.6em' // Approx 3 lines
                }}>
